        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              <h3 className="text-xl font-bold mb-2"> Mobile Controller App</h3>
              <p className="text-gray-400 mb-4">
                Wireless smartphone game controller with customizable layouts, gyroscopic motion controls, and ultra-low latency networking.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["Java", "C#", "Android Studio"].map((tech, key) => (
                  <span
                    key={key}
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://mobcontrolfyp.netlify.app/"
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://drive.google.com/drive/folders/1dvkZZ6ch0rbfI9eGZYZWyGCGnJzemUrd?usp=drive_link"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
                  View Project →
                </a>
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://e-commerce-nine-tan-58.vercel.app/"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
                  View Project →
                </a>
...
photo galleries, and social integration features built with Next.js and PostgreSQL.
              ...
              <div className="flex justify-between items-center ">
                <a
                  href="https://travel-planner-gold.vercel.app/"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
                  View Project →
                </a>
